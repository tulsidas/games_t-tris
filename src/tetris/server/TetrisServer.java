...
public class TetrisServer {
   private static final int SERVER_PORT = 8870;

   private static final int HTTP_PORT = 8871;

   private static final int JMX_PORT = 8872;

   private static final int RMI_PORT = 8873;

   private static Logger log = LoggerFactory.getLogger(TetrisServer.class);
   ...
   public static void main(String[] args) throws Throwable {
      ...
      TetrisSessionHandler server = new TetrisSessionHandler();
      ...
      ObjectName bean = new ObjectName("TetrisServer:type=TetrisServiceManager");
